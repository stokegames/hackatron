class Component {
    ...
    init() {
        ...
        var beginSwipe = function() {
            startX = this.game.game.input.worldX;
            startY = this.game.game.input.worldY;
            this.game.game.input.onDown.remove(beginSwipe, this);
            this.game.game.input.onUp.add(endSwipe, this);
        };

        // function to be called when the player releases the mouse/finger
        var endSwipe = function() {
            // saving mouse/finger coordinates
            endX = this.game.game.input.worldX;
            endY = this.game.game.input.worldY;
            ...
            this.game.game.input.onDown.add(beginSwipe, this);
            this.game.game.input.onUp.remove(endSwipe, this);
        };
